...
const std::string green_arm_joints_names[7] = {"pa10_green_shoulder_roll_joint", 
  "pa10_green_shoulder_lift_joint", "pa10_green_upper_arm_roll_joint",
  "pa10_green_elbow_flex_joint", "pa10_green_forearm_roll_joint",
  "pa10_green_wrist_flex_joint", "pa10_green_wrist_roll_joint"};
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "move_left_odr_axs_pa10");
